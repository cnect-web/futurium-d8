...
class EntityActivityTrackerForm extends EntityForm {
  ...
  //   $processor_id = $form_state->getValue('activity_processor');

  //   /** @var \Drupal\fut_activity\Plugin\ActivityProcessorInterface $processor */
  //   try {
  //     //code...
  //     $processor = $this->manager->createInstance($processor_id);

  //     $processor_subform = $processor->buildConfigurationForm($form, $form_state);
  //     return $processor_subform;
  ...
  //     $form['processor_subform'][$processor_id]['settings'] = [];
  ...
  //   /** @var \Drupal\fut_activity\Entity\EntityActivityTrackerInterface $tracker */
  //   $tracker = $this->entity;
  //   $configured_conditions = [];
  //   foreach ($tracker->getProcessors() as $row => $processor) {
  //     /** @var \Drupal\fut_activity\Plugin\ActivityProcessorInterface $instance */
  //     $instance = $this->manager->createInstance($processor['id'], $processor);

  //     // $operations = $this->getOperations(); I need a method here to give me the delete link.
