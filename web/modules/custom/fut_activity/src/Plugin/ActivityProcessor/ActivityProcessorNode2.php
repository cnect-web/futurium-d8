 ...
 *
 * @ActivityProcessor (
 *   id = "activity_processor_node2",
 *   label = @Translation("Node Processor2")
 * )
 *
 */
class ActivityProcessorNode2 extends ActivityProcessorBase implements ContainerFactoryPluginInterface {
